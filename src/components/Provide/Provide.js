            ...
            <div className="provide-box">
              ...
              <div className={`provide-item ${allTitlesVisible ? 'visible' : ''}`}>
                <svg className="provide-item__icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <path d="M4.4224 18.2745C5.94578 18.2745 7.18073 17.0395 7.18073 15.5161C7.18073 13.9928 5.94578 12.7578 4.4224 12.7578C2.89901 12.7578 1.66406 13.9928 1.66406 15.5161C1.66406 17.0395 2.89901 18.2745 4.4224 18.2745Z" stroke="black" strokeMiterlimit="10" />
                </svg>
                <span>GROW FAR</span>
              </div>
            </div>
